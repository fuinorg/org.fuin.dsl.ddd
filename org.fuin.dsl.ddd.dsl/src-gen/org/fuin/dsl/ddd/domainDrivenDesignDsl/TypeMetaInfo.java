 ...
 *   <li>{@link org.fuin.dsl.ddd.domainDrivenDesignDsl.TypeMetaInfo#getTooltipp <em>Tooltipp</em>}</li>
...
public interface TypeMetaInfo extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Tooltipp</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Tooltipp</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Tooltipp</em>' attribute.
   * @see #setTooltipp(String)
   * @see org.fuin.dsl.ddd.domainDrivenDesignDsl.DomainDrivenDesignDslPackage#getTypeMetaInfo_Tooltipp()
   * @model
   * @generated
   */
  String getTooltipp();
  ...
  /**
   * Sets the value of the '{@link org.fuin.dsl.ddd.domainDrivenDesignDsl.TypeMetaInfo#getTooltipp <em>Tooltipp</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Tooltipp</em>' attribute.
   * @see #getTooltipp()
   * @generated
   */
  void setTooltipp(String value);
