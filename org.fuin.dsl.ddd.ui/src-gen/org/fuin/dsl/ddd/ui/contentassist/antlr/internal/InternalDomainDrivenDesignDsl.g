...
:
(
{ before(grammarAccess.getConstraintAccess().getMessageSTRINGTerminalRuleCall_8_0()); }
	RULE_STRING{ after(grammarAccess.getConstraintAccess().getMessageSTRINGTerminalRuleCall_8_0()); }
)
