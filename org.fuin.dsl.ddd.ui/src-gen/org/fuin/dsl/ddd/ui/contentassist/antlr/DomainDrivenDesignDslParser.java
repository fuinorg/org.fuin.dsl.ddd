		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityIdAccess().getInvariantsAssignment_6(), "rule__EntityId__InvariantsAssignment_6");
					put(grammarAccess.getEntityIdAccess().getMetaInfoAssignment_8(), "rule__EntityId__MetaInfoAssignment_8");
					put(grammarAccess.getEntityIdAccess().getAttributesAssignment_9(), "rule__EntityId__AttributesAssignment_9");
					put(grammarAccess.getEntityIdAccess().getConstructorsAssignment_10(), "rule__EntityId__ConstructorsAssignment_10");
					put(grammarAccess.getEntityIdAccess().getMethodsAssignment_11(), "rule__EntityId__MethodsAssignment_11");
					...
					put(grammarAccess.getAggregateIdAccess().getInvariantsAssignment_6(), "rule__AggregateId__InvariantsAssignment_6");
					put(grammarAccess.getAggregateIdAccess().getMetaInfoAssignment_8(), "rule__AggregateId__MetaInfoAssignment_8");
					put(grammarAccess.getAggregateIdAccess().getAttributesAssignment_9(), "rule__AggregateId__AttributesAssignment_9");
					put(grammarAccess.getAggregateIdAccess().getConstructorsAssignment_10(), "rule__AggregateId__ConstructorsAssignment_10");
					put(grammarAccess.getAggregateIdAccess().getMethodsAssignment_11(), "rule__AggregateId__MethodsAssignment_11");
					...
					put(grammarAccess.getEntityAccess().getInvariantsAssignment_7(), "rule__Entity__InvariantsAssignment_7");
					put(grammarAccess.getEntityAccess().getMetaInfoAssignment_9(), "rule__Entity__MetaInfoAssignment_9");
					put(grammarAccess.getEntityAccess().getAttributesAssignment_10(), "rule__Entity__AttributesAssignment_10");
					put(grammarAccess.getEntityAccess().getConstructorsAssignment_11(), "rule__Entity__ConstructorsAssignment_11");
					put(grammarAccess.getEntityAccess().getMethodsAssignment_12(), "rule__Entity__MethodsAssignment_12");
					put(grammarAccess.getEntityAccess().getEventsAssignment_13(), "rule__Entity__EventsAssignment_13");
					...
					put(grammarAccess.getAggregateAccess().getInvariantsAssignment_5(), "rule__Aggregate__InvariantsAssignment_5");
					put(grammarAccess.getAggregateAccess().getMetaInfoAssignment_7(), "rule__Aggregate__MetaInfoAssignment_7");
					put(grammarAccess.getAggregateAccess().getAttributesAssignment_8(), "rule__Aggregate__AttributesAssignment_8");
					put(grammarAccess.getAggregateAccess().getConstructorsAssignment_9(), "rule__Aggregate__ConstructorsAssignment_9");
					put(grammarAccess.getAggregateAccess().getMethodsAssignment_10(), "rule__Aggregate__MethodsAssignment_10");
					put(grammarAccess.getAggregateAccess().getEventsAssignment_11(), "rule__Aggregate__EventsAssignment_11");
