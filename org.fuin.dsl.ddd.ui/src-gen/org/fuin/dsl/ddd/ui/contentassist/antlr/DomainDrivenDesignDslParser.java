		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionAccess().getGroup_6_3(), "rule__Function__Group_6_3__0");
					...
					put(grammarAccess.getMethodAccess().getFunctionsAssignment_6(), "rule__Method__FunctionsAssignment_6");
					put(grammarAccess.getMethodAccess().getConstraintsAssignment_7(), "rule__Method__ConstraintsAssignment_7");
					put(grammarAccess.getMethodAccess().getEventsAssignment_8(), "rule__Method__EventsAssignment_8");
					...
					put(grammarAccess.getFunctionAccess().getDocAssignment_0(), "rule__Function__DocAssignment_0");
					put(grammarAccess.getFunctionAccess().getNameAssignment_2(), "rule__Function__NameAssignment_2");
					put(grammarAccess.getFunctionAccess().getInputAssignment_4_2(), "rule__Function__InputAssignment_4_2");
					put(grammarAccess.getFunctionAccess().getOutDocAssignment_5_0(), "rule__Function__OutDocAssignment_5_0");
					put(grammarAccess.getFunctionAccess().getOutputAssignment_5_2(), "rule__Function__OutputAssignment_5_2");
					put(grammarAccess.getFunctionAccess().getExceptionsAssignment_6_2(), "rule__Function__ExceptionsAssignment_6_2");
					put(grammarAccess.getFunctionAccess().getExceptionsAssignment_6_3_1(), "rule__Function__ExceptionsAssignment_6_3_1");
					...
					put(grammarAccess.getServiceAccess().getFunctionsAssignment_4(), "rule__Service__FunctionsAssignment_4");
