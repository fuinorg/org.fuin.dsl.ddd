		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConstraintAccess().getMessageAssignment_9(), "rule__Constraint__MessageAssignment_9");
					...
					put(grammarAccess.getEntityIdAccess().getMetaInfoAssignment_4(), "rule__EntityId__MetaInfoAssignment_4");
					put(grammarAccess.getEntityIdAccess().getVariablesAssignment_5(), "rule__EntityId__VariablesAssignment_5");
					put(grammarAccess.getEntityIdAccess().getConstructorsAssignment_6(), "rule__EntityId__ConstructorsAssignment_6");
					put(grammarAccess.getEntityIdAccess().getMethodsAssignment_7(), "rule__EntityId__MethodsAssignment_7");
					...
					put(grammarAccess.getAggregateIdAccess().getMetaInfoAssignment_4(), "rule__AggregateId__MetaInfoAssignment_4");
					put(grammarAccess.getAggregateIdAccess().getVariablesAssignment_5(), "rule__AggregateId__VariablesAssignment_5");
					put(grammarAccess.getAggregateIdAccess().getConstructorsAssignment_6(), "rule__AggregateId__ConstructorsAssignment_6");
					put(grammarAccess.getAggregateIdAccess().getMethodsAssignment_7(), "rule__AggregateId__MethodsAssignment_7");
					...
					put(grammarAccess.getEntityAccess().getMetaInfoAssignment_6(), "rule__Entity__MetaInfoAssignment_6");
					put(grammarAccess.getEntityAccess().getVariablesAssignment_7(), "rule__Entity__VariablesAssignment_7");
					put(grammarAccess.getEntityAccess().getConstructorsAssignment_8(), "rule__Entity__ConstructorsAssignment_8");
					put(grammarAccess.getEntityAccess().getMethodsAssignment_9(), "rule__Entity__MethodsAssignment_9");
