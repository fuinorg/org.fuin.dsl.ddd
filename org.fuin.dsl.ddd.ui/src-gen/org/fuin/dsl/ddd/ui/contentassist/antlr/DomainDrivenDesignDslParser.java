		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVariableAccess().getAlternatives_9(), "rule__Variable__Alternatives_9");
					...
					put(grammarAccess.getConstraintAccess().getTargetAssignment_4(), "rule__Constraint__TargetAssignment_4");
					put(grammarAccess.getConstraintAccess().getExceptionAssignment_5_1(), "rule__Constraint__ExceptionAssignment_5_1");
					put(grammarAccess.getConstraintAccess().getVariablesAssignment_7(), "rule__Constraint__VariablesAssignment_7");
					put(grammarAccess.getConstraintAccess().getMessageAssignment_8(), "rule__Constraint__MessageAssignment_8");
					...
					put(grammarAccess.getValueObjectAccess().getMetaInfoAssignment_4(), "rule__ValueObject__MetaInfoAssignment_4");
					put(grammarAccess.getValueObjectAccess().getVariablesAssignment_5(), "rule__ValueObject__VariablesAssignment_5");
					put(grammarAccess.getValueObjectAccess().getConstructorsAssignment_6(), "rule__ValueObject__ConstructorsAssignment_6");
					put(grammarAccess.getValueObjectAccess().getMethodsAssignment_7(), "rule__ValueObject__MethodsAssignment_7");
					...
					put(grammarAccess.getEntityAccess().getMetaInfoAssignment_4(), "rule__Entity__MetaInfoAssignment_4");
					put(grammarAccess.getEntityAccess().getVariablesAssignment_5(), "rule__Entity__VariablesAssignment_5");
					put(grammarAccess.getEntityAccess().getConstructorsAssignment_6(), "rule__Entity__ConstructorsAssignment_6");
					put(grammarAccess.getEntityAccess().getMethodsAssignment_7(), "rule__Entity__MethodsAssignment_7");
					...
					put(grammarAccess.getAggregateAccess().getMetaInfoAssignment_4(), "rule__Aggregate__MetaInfoAssignment_4");
					put(grammarAccess.getAggregateAccess().getVariablesAssignment_5(), "rule__Aggregate__VariablesAssignment_5");
					put(grammarAccess.getAggregateAccess().getConstructorsAssignment_6(), "rule__Aggregate__ConstructorsAssignment_6");
					put(grammarAccess.getAggregateAccess().getMethodsAssignment_7(), "rule__Aggregate__MethodsAssignment_7");
					...
					put(grammarAccess.getConstructorAccess().getConstraintsAssignment_5(), "rule__Constructor__ConstraintsAssignment_5");
					put(grammarAccess.getConstructorAccess().getEventsAssignment_6(), "rule__Constructor__EventsAssignment_6");
					...
					put(grammarAccess.getMethodAccess().getConstraintsAssignment_6(), "rule__Method__ConstraintsAssignment_6");
					put(grammarAccess.getMethodAccess().getEventsAssignment_7(), "rule__Method__EventsAssignment_7");
					...
					put(grammarAccess.getTypeMetaInfoAccess().getTooltippAssignment_3_1(), "rule__TypeMetaInfo__TooltippAssignment_3_1");
					...
					put(grammarAccess.getVariableAccess().getTechnicalIdAssignment_1(), "rule__Variable__TechnicalIdAssignment_1");
					put(grammarAccess.getVariableAccess().getBusinessKeyAssignment_2(), "rule__Variable__BusinessKeyAssignment_2");
					put(grammarAccess.getVariableAccess().getBusinessNameAssignment_3(), "rule__Variable__BusinessNameAssignment_3");
					put(grammarAccess.getVariableAccess().getNullableAssignment_4(), "rule__Variable__NullableAssignment_4");
					put(grammarAccess.getVariableAccess().getTypeAssignment_5(), "rule__Variable__TypeAssignment_5");
					put(grammarAccess.getVariableAccess().getMultiplicityAssignment_6(), "rule__Variable__MultiplicityAssignment_6");
					put(grammarAccess.getVariableAccess().getNameAssignment_7(), "rule__Variable__NameAssignment_7");
					put(grammarAccess.getVariableAccess().getInvariantsAssignment_8(), "rule__Variable__InvariantsAssignment_8");
					put(grammarAccess.getVariableAccess().getOverriddenAssignment_9_0(), "rule__Variable__OverriddenAssignment_9_0");
