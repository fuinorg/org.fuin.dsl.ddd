		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityIdAccess().getBaseAssignment_3_1(), "rule__EntityId__BaseAssignment_3_1");
					put(grammarAccess.getEntityIdAccess().getMetaInfoAssignment_5(), "rule__EntityId__MetaInfoAssignment_5");
					put(grammarAccess.getEntityIdAccess().getVariablesAssignment_6(), "rule__EntityId__VariablesAssignment_6");
					put(grammarAccess.getEntityIdAccess().getConstructorsAssignment_7(), "rule__EntityId__ConstructorsAssignment_7");
					put(grammarAccess.getEntityIdAccess().getMethodsAssignment_8(), "rule__EntityId__MethodsAssignment_8");
					...
					put(grammarAccess.getAggregateIdAccess().getBaseAssignment_3_1(), "rule__AggregateId__BaseAssignment_3_1");
					put(grammarAccess.getAggregateIdAccess().getMetaInfoAssignment_5(), "rule__AggregateId__MetaInfoAssignment_5");
					put(grammarAccess.getAggregateIdAccess().getVariablesAssignment_6(), "rule__AggregateId__VariablesAssignment_6");
					put(grammarAccess.getAggregateIdAccess().getConstructorsAssignment_7(), "rule__AggregateId__ConstructorsAssignment_7");
					put(grammarAccess.getAggregateIdAccess().getMethodsAssignment_8(), "rule__AggregateId__MethodsAssignment_8");
